    ...
    return (
        <div className="item-center mx-auto my-8 flex flex-col justify-center gap-6 lg:my-[130px] lg:max-w-[1140px] lg:flex-row">
            <Image
                ...
                width={558}
                height={1053}
                className="mx-auto max-h-[633px] max-w-[300px] md:max-h-[1053px] md:w-1/2 md:max-w-[558px]"
            />
            <div className="mx-auto w-[300px] text-center md:w-1/2 lg:text-left">
                ...
                <div className="*:p x-4 mb-4 flex items-center justify-between rounded-[10px] border border-[#E6E6E6] text-xl font-bold text-[#3B3A3A] *:rounded-[10px] *:py-[27px] md:mb-[50px] md:text-lg">
