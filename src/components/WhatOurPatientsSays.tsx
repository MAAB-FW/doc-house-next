...
export default function WhatOurPatientsSays() {
    return (
        <section className="mx-auto my-8 lg:my-[130px] lg:max-w-[1140px]">
            ...
            <div className="grid grid-cols-1 gap-6 *:mx-auto *:w-[335px] *:flex-shrink *:rounded-[0.625rem] *:border *:p-[1.875rem] lg:grid-cols-2 *:lg:h-[290px] *:lg:w-[558px] *:lg:p-[3.125rem] *:lg:pr-11">
                {/* Card 1 */}
                <ReviewCard
                    name={"Awlad Hossain"}
