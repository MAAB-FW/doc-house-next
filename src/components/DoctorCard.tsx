import type { TDoctorCard } from "@/types/types";
import Image from "next/image";


export default function DoctorCard({ name, profession, ratings, location, availability, price, doctorImage }: TDoctorCard) {
    return (
        <div className="space-y-5">
                ...
                <div className="mt-[0.625rem] flex items-center">
                    {[...Array(5)].map((_, index) => (
                        <svg
                            ...
                            viewBox="0 0 24 24"
                            fill="none"
                            className={`h-5 w-5 ${index < ratings ? "text-yellow-500" : "text-gray-300"}`}
                        >
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
            ...
            <hr />
            <div className="space-y-[0.625rem] text-[#6C6B6B] *:flex *:items-center *:gap-5">
                <div>
            ...
            <button className="w-full rounded-[0.625rem] border border-[#F7A582] py-[0.875rem] text-xl font-bold text-[#F7A582] transition-all hover:bg-[#F7A582] hover:text-white">
                View Profile
            </button>
        </div>
    );
